...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <!--TODO: obczaic te nawigacje - bo czy chcemy linkowac miedzy plikami? nope...-->
...
Your group folders
    ...
    <!--TODO: czy nie da sie lepiej?-->
    <!--<fb:login-button scope="public_profile,email,user_groups,publish_actions" onlogin="checkLoginState();">-->
    <!--</fb:login-button>-->
    <div id="status">
    </div>
